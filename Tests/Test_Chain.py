...
BC.submitBlock(MineBlock(Block(0, "", 0, [], 100, UserA.get_public_str(), "Genesis_Block"), BC.difficulty))
# Create test block 1&2 with transactions
BC.submitBlock(MineBlock(Block(1, "", 0, [t1, t2, t3], 100, UserA.get_public_str(), BC.currBlock.currHash), BC.difficulty))
BC.submitBlock(MineBlock(Block(2, "", 0, [t4, t5], 100, UserA.get_public_str(), BC.currBlock.currHash), BC.difficulty))

# Print & Verify
for block in BC.blockList:
